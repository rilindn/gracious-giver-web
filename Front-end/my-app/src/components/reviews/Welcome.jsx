    ...
    <div>
      ...
      <div className="d-flex justify-content-start align-items-center bg-img">
        <div className="d-flex flex-column review-inner-container">
          ...
          <p style={{ fontSize: '19pt' }}>
            Millions of people around the world are giving and
            <br /> getting free things in their local communities.
          </p>
          <div className="d-flex align-items-center give-browse">
            <a href={loggedInUser!==undefined?"/home":"/login"}>
                <Button className="give-browse-btn text-30 font-weight-bold">
            ...
            <a href={loggedInUser!==undefined?"/home":"/login"}>
                <Button className="give-browse-btn font-weight-bold">
              Browse
              <img
                src={arrowIcon}
                alt=""
                style={{ width: '30px', margin: '0 0 10px 8px' }}
              ></img>{' '}
            </Button></a>
              ...
              <Media className="media">
                ...
                <div className="media-body ml-3">
                  <blockquote className="blockquote border-0 p-0">
                    <p className="font-italic lead q-width">
                      <FontAwesomeIcon className="mr-3" icon={faQuoteLeft} />I
                      have gotten so many great items from this site. A swimming
                      pool, kids playhouse and more-love it .
                      <FontAwesomeIcon className="ml-3" icon={faQuoteRight} />
                    </p>
                ...
                <div className="media-body ml-3">
                  <blockquote className="blockquote border-0 p-0">
                    <p className="font-italic lead q-width">
                      ...
                      This is so handy! I've been using freecycle for ages but
              ...
              <div className="media">
                ...
                <div className="media-body ml-3">
                  <blockquote className="blockquote border-0 p-0">
                    <p className="font-italic lead q-width">
                      <FontAwesomeIcon className="mr-3" icon={faQuoteLeft} />
                      Brilliant! Really easy to use, as a mother of 5 kids this
                      has been very handy indeed with regards to doing up my
                      house.
                      <FontAwesomeIcon className="ml-3" icon={faQuoteRight} />
                    </p>
              ...
              <Media className="media">
                ...
                <div className="media-body ml-3">
                  <blockquote className="blockquote border-0 p-0">
                    <p className="font-italic lead q-width">
                      <FontAwesomeIcon className="mr-3" icon={faQuoteLeft} />
                      Works great! Much easier than using the freecycle website.
                      Highly recommend it!.
                      <FontAwesomeIcon className="ml-3" icon={faQuoteRight} />
                    </p>
              ...
              <Media>
                ...
                <div className="media-body ml-3">
                  <blockquote className="blockquote border-0 p-0">
                    <p className="font-italic lead q-width">
                      <FontAwesomeIcon className="mr-3" icon={faQuoteLeft} />I
                      absolutely love this app! There is always someone nice to
              ...
              <div className="media">
                ...
                <div className="media-body ml-3">
                  <blockquote className="blockquote border-0 p-0">
                    <p className="font-italic lead q-width">
                      <FontAwesomeIcon className="mr-3" icon={faQuoteLeft} />
                      I've received a free 55" TV, some cleaning supplies, and
                      more. Don't forget to post the things you no longer need!
                      I do! And it's the "cycle" in Freecycle! Love it!.
                      <FontAwesomeIcon className="ml-3" icon={faQuoteRight} />
                    </p>
              ...
              <Media className="media">
                ...
                <div className="media-body ml-3">
                  <blockquote className="blockquote border-0 p-0">
                    <p className="font-italic lead q-width">
                      <FontAwesomeIcon className="mr-3" icon={faQuoteLeft} />
                      Really great app, helping to keep reusable/upcyclable
              ...
              <div className="media">
                ...
                <div className="media-body ml-3">
                  <blockquote className="blockquote border-0 p-0">
                    <p className="font-italic lead q-width">
                      <FontAwesomeIcon className="mr-3" icon={faQuoteLeft} />
                      Wonderful service. I have found several items and always
                      had a great experience. I also gave away several items and
            ...
            <Col className="align-self-center">
              <div className="video-btn text-left">
                <h3 className="d-inline-block">
                  <FontAwesomeIcon className="mr-3" icon={faPlusCircle} /> Post
                  an item
                </h3>
                <h3 className="d-inline-block mt-3 mb-4 ">
                  <FontAwesomeIcon className="mr-3" icon={faUserPlus} />
                  Choose a recipient
                </h3>
                <h3 className="d-inline-block">
                  <FontAwesomeIcon className="mr-4" icon={faRedoAlt} />
                  Repeat
                </h3>
              </div>
