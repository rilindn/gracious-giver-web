            ...
            <Tabs defaultActiveKey="MyProfile" id="uncontrolled-tab-example">
               ...
               <form onSubmit={handleSubmit}>
                <div class="row mt-5 align-items-center">
                    <div class="col-md-3 text-center mb-5">
                        <div class="avatar avatar-xl">
                            <img src={imgSrc} alt="..." class="avatar-img rounded-circle" />
                        </div>
                    </div>
                    <div class="col">
                        <div class="row align-items-center">
                            <div class="col-md-7">
                                ...
                                <p class="small mb-3"><span class="badge badge-dark">{organization.State}, {organization.City}</span></p>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col-md-10">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input  name="Name" defaultValue={organization.Name} type="text" class="form-control" id="Name" placeholder="Username" />
                </div>
                <div class="form-group col-md-6">
                    <label for="Username"> Username</label>
                    <input  name="Username" defaultValue={organization.Username} type="text" class="form-control" id="Username" placeholder="Username" />
                </div>
                </div>
                <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="inputEmail4">Email</label>
                    <input  name="Email" defaultValue={organization.Email} type="email" class="form-control" id="inputEmail4" placeholder="brown@asher.me" />
                </div>
                <div class="form-group col-md-6">
                    ...
                    >
                      {categories.map((category) => (
                        <option value={category.OrganizationCategoryName} >{category.OrganizationCategoryName}</option>
                      ))}
                    </select>
                  </div>
                  </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <select name="City" id="City" class="form-control" value={selectedCity}
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <textarea name="Description" defaultValue={organization.Description} class="form-control"  />
                </div>
